    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='designaciones_creadas', to=settings.AUTH_USER_MODEL)),
                ('dedicacion', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='designaciones', to='gestion_academica.dedicacion')),
                ...
                ('documento', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='designaciones', to='gestion_academica.documento')),
                ('modalidad', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='designaciones', to='gestion_academica.modalidad')),
                ('regimen', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='designaciones', to='gestion_academica.parametrosregimen')),
            ],
        ),
        migrations.CreateModel(
            name='PlanAsignatura',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('documento', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='planes', to='gestion_academica.documento')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddConstraint(
            model_name='usuario',
            constraint=models.UniqueConstraint(fields=('email',), name='uq_email_unico'),
        ),
        migrations.AddConstraint(
